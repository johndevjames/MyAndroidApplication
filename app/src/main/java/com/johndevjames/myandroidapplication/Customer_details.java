...
public class Customer_details extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        this.tutorialList = this.Cd.getAllCustDeatils();
        ...
        ((ListView) findViewById(R.id.list_main)).setOnItemClickListener(new OnItemClickListener() {
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                for (int i = 0; i < tutorialList.size(); i++) {
                    Customer_details.this.PAR.add(i, ((Tutorial2) tutorialList.get(i)).getcustomer_id());
                }
                int newposition = ((Integer) Customer_details.this.PAR.get(position)).intValue();
