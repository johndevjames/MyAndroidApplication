...
public class Createdetails extends HomeActivity {
    ...
    public List getSinlgeEntry() {
        ...
        while (cursor.moveToNext()) {
            ...
            Details.add(new Tutorial3(Integer.valueOf(id), cursor.getString(cursor.getColumnIndex("SHOP_NAME"))));
        }
        cursor.close();
        return Details;
    }
    ...
    public List getAllCustDeatils() {
        ...
        List Details = new ArrayList();
        while (cursor.moveToNext()) {
            Details.add(new Tutorial2(Integer.valueOf(cursor.getInt(cursor.getColumnIndex("SHOP_ID"))), cursor.getString(cursor.getColumnIndex("SHOP_NAME")), Integer.valueOf(cursor.getInt(cursor.getColumnIndex("PENDING_AMOUNT")))));
        }
        cursor.close();
        return Details;
    }

    public void updateEntry(String ShopId, String ShopName, String OwnerName, String ShopPlace, String ShopAddress, String PhoneNumber, String MobileNumber, String Area, String district, String Email, String Pin, String Tin, String Land_mark, String PenAmt, String usr_name, String last_update, Integer position) {
        ContentValues updatedValues = new ContentValues();
